...
PizzaList pizzaList = PizzaList(pizzas: [
  Pizza(
    ...
    background: const Color(0xfff2ca80),
  ...
  Pizza(
    ...
    desc:
    "Mozzarella Cheeze, Buffalo blue sauce, and your choice of grilled chicken or crispy chicken fingers",
    background: const Color(0xffd82a12),
  ...
  Pizza(
    ...
    desc:
    "Mozzarella Cheeze, Buffalo blue sauce, and your choice of grilled chicken or crispy chicken fingers",
    background: const Color(0xff4fc420),
    foreground: Colors.black,
    price: 12.99,
  ),
  Pizza(
    ...
    desc:
    "Mozzarella Cheeze, Buffalo blue sauce, and your choice of grilled chicken or crispy chicken fingers",
    background: const Color(0xff5d2512),
    foreground: Colors.white,
    price: 12.99,
  ),
  Pizza(
    ...
    desc:
    "Mozzarella Cheeze, Buffalo blue sauce, and your choice of grilled chicken or crispy chicken fingers",
    background: const Color(0xffdddbd8),
    foreground: Colors.black,
    price: 12.99,
  ),
  Pizza(
    ...
    desc:
    "Mozzarella Cheeze, Buffalo blue sauce, and your choice of grilled chicken or crispy chicken fingers",
    background: const Color(0xffd54b1c),
    foreground: Colors.white,
    price: 12.99,
  ),
]);
