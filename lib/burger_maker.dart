...
class MakeBurgerPage extends StatefulWidget {
  const MakeBurgerPage({super.key});

  @override
  _MakeBurgerPageState createState() => _MakeBurgerPageState();
}

class _MakeBurgerPageState extends State<MakeBurgerPage>
      ...
      Container(
        ...
        child: ClipOval(
          ...
          child: Image.asset('assets/burger.jpg',
              fit: BoxFit.contain), // replace with your image
        ),
      ),
